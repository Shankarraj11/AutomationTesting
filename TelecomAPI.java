...
public class TelecomAPI 
{
  ...
  public void addNewUser() 
  {
	  ...
	  .body("{ \n"
	  		+ "\"firstName\": \"Priyanka\", \n"
	  		+ "\"lastName\": \"Nigade\", \n"
	  		+ "\"email\": \"priyanka"+System.currentTimeMillis()+"@gmail.com\", \n"
	  		+ "\"password\": \"test123\" \n"
	  		+ "}")
  ...
  public void updateUser()
  {
	  ...
	  .body("{ \n"
	  		+ "\"firstN ame\": \"Priyanka\", \n"
	  		+ "\"lastName\": \"Nigade\", \n"
	  		+ "\"email\": \"PriyankaTest"+System.currentTimeMillis()+"@gmail.com.com\", \n"
	  		+ "\"password\": \"test123\" \n"
	  		+ "} ")
